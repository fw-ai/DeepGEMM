...
public:
    struct Args {
        ...
        int overlap_post_down_route_threads = 0;
        LaunchArgs launch_args;
    };
...
static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(
        ...
        >);
            ...
            args.overlap_post_down_route_threads,
...
static void sm100_bf16_mega_moe_backward_dgrad(
    ...
    const int& overlap_post_down_route_threads,
    ...
    const auto runtime = compiler->build(
        fmt::format(
            "sm100_bf16_mega_moe_backward_dgrad_trace{}_vec{}_wide{}_route_threads{}",
            kernel_trace.has_value(),
