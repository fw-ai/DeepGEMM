...
def fp8_fp4_mega_moe_backward_dgrad_swiglu(
    ...
    build_residual_mxfp8_weights: bool = False,
    ...
    if build_residual_mxfp8_weights and residual_dgrad_weights is None:
        raise ValueError(
            "in-kernel residual MXFP8 weight construction requires aliased "
            "residual_dgrad_weights outputs"
        )
