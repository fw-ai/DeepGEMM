...
template <cute::UMMA::Major kMajorA, cute::UMMA::Major kMajorB,
          ...
          GemmType kGemmType, bool kWithAccumulation, typename cd_dtype_t, typename epilogue_op_t,
...
sm100_bf16_gemm_impl(int* grouped_layout,
    ...
    auto scheduler = sched::Scheduler<kGemmType, BLOCK_M, BLOCK_N, kNumGroups, kNumMulticast, kIsMulticastOnA, kNumSMs, kEnsureZeroPadding, kKAlignment, kKAlignment, BLOCK_K>(
